      ...
      <div class="row text-center align-items-center flex-row-reverse">
        <div class="col-lg-auto ms-lg-auto">
          <ul class="list-inline list-inline-dots mb-0">
            <li class="list-inline-item"><a href="#" class="link-secondary">Teknologi Informasi</a></li>
            <li class="list-inline-item"><a href="#" class="link-secondary">Sistem Informasi</a></li>
            <li class="list-inline-item"><a href="#" target="_blank" class="link-secondary" rel="noopener">Umum - Pengadaan</a></li>
        ...
        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
          <ul class="list-inline list-inline-dots mb-0">
            <li class="list-inline-item">
              Copyright © 2023 - {{ now()->year }}
              <a href="#" class="link-secondary">All rights reserved</a>.
